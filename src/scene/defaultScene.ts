  ...
  return {
    ...
    objects: [
      ...
      },
      {
        ...
        x: 80, y: 130, groupId: 'header',
        text: 'RUN', fontFamily: 'Inter', fontSize: 96, fontWeight: 900,
      ...
      },
      {
        ...
        x: 80, y: 238, groupId: 'header',
        text: 'MAR 15, 2024', fontFamily: 'Inter', fontSize: 22, fontWeight: 600,
